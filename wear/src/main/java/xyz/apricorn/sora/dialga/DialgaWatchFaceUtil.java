...
public final class DialgaWatchFaceUtil {
    private static final String TAG = "DialgaWatchFaceUtil";

    public static final String TEAM_LEAD_KEY = "TEAM_LEAD";
    public static final String SLOT_2_KEY = "SLOT_2";
    public static final String SLOT_3_KEY = "SLOT_3";
    public static final String SLOT_4_KEY = "SLOT_4";
    public static final String SLOT_5_KEY = "SLOT_5";
    public static final String SLOT_6_KEY = "SLOT_6";

    /**
     * The {@link DataMap} key for {@link DialgaWatchFaceService} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    *
     * The {@link DataMap} key for {@link DialgaWatchFaceService} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    *
     * The {@link DataMap} key for {@link DialgaWatchFaceService} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    *
     * The {@link DataMap} key for {@link DialgaWatchFaceService} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
    public static final String KEY_SECONDS_COLOR = "SECONDS_COLOR";

    *
     * The path for the {@link DataItem} containing {@link DialgaWatchFaceService} configuration.
*/
    public static final String PATH_WITH_FEATURE = "/watch_face_config/Dialga";
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link DialgaWatchFaceService}
                ...
                new ResultCallback<NodeApi.GetLocalNodeResult>() {
                    ...
                    public void onResult(NodeApi.GetLocalNodeResult getLocalNodeResult) {
                        ...
                        Uri uri = new Uri.Builder()
                                .scheme("wear")
                                .path(DialgaWatchFaceUtil.PATH_WITH_FEATURE)
                                .authority(localNode)
                                .build();
    ...
    public static void overwriteKeysInConfigDataMap(final GoogleApiClient googleApiClient,
        ...
        DialgaWatchFaceUtil.fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        DialgaWatchFaceUtil.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
